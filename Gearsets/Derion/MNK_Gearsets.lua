...
if player.name == 'Derion' then
		...
		sets.idle.PDT = { 
					...
					body="Hizamaru Haramaki", hands="Hizamaru Kote", lring=Aug.Darkring1.Derion, rring="",
		...
		sets.misc.Waltz = {}
		sets.misc.Steps = {head="Hizamaru Somen", neck="Peacock Amulet", lear="Bladeborn Earring", rear="Steelflash Earring",
