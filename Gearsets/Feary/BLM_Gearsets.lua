...
if player.Name == 'Feary' then
	...
	-- Elemental
	-- Skill
	sets.midcast.Elemental = {main={name="Lathi", priority=2}, sub={name="Zuuxowu Grip", priority=1}, ammo="Dosis Tathlum",
	...
	-- Damage
	sets.midcast.Nuke = {main={name="Lathi", priority=2}, sub={name="Zuuxowu Grip", priority=1}, ammo="Dosis Tathlum",
			...
			back=Aug.Cape.BLM.MACC, waist="Wanion Belt", legs="Amalric Slops", feet="Amalric Nails"}
	-- Acc
	sets.midcast.Nuke.Acc = {main={name="Lathi", priority=2}, sub={name="Zuuxowu Grip", priority=1}, ammo="Dosis Tathlum",
			head="Jhakri Coronal +1", neck="Eddy Necklace", lear="Barkaro. Earring", rear="Friomisi Earring",
			body="Spaekona's Coat", hands="Amalric Gages", lring="Shiva Ring +1", rring="Shiva Ring +1",
			back=Aug.Cape.BLM.MACC, waist="Wanion Belt", legs="Amalric Slops", feet="Amalric Nails"}
	
	-- Magic Burst
	sets.midcast.Nuke.MB = {main={name="Lathi", priority=2}, sub={name="Zuuxowu Grip", priority=1}, ammo="Dosis Tathlum",
			...
			back=Aug.Cape.BLM.MACC, waist="Wanion Belt", legs="Amalric Slops", feet="Amalric Nails"}
	-- Magic Burst Acc
	sets.midcast.Nuke.MB.Acc = {main={name="Lathi", priority=2}, sub={name="Zuuxowu Grip", priority=1}, ammo="Dosis Tathlum",
			head="Jhakri Coronal +1", neck="Mizukage-no-Kubikazari", lear="Barkaro. Earring", rear="Friomisi Earring",
			body="Spaekona's Coat", hands="Amalric Gages", lring="Shiva Ring +1", rring="Locus Ring",
			back=Aug.Cape.BLM.MACC, waist="Wanion Belt", legs="Amalric Slops", feet="Amalric Nails"}
	...
	-- Death
	sets.idle.Death = {
			main={name="Lathi", priority=2}, sub={name="Zuuxowu Grip", priority=1}, ammo="Dosis Tathlum",
			head="Jhakri Coronal +1", neck="Mizukage-no-Kubikazari", lear="Barkaro. Earring", rear="Friomisi Earring",
			body="Jhakri Robe +1", hands="Amalric Gages", lring="Shiva Ring +1", rring="Locus Ring",
			back=Aug.Cape.BLM.MACC, waist="Wanion Belt", legs="Amalric Slops", feet="Amalric Nails"}
	...
	-- Enfeebling
	-- Potency
	sets.midcast.Enfeebling = {main={name="Lathi", priority=2}, sub={name="Mephitis Grip", priority=1}, 
	...
	sets.midcast.Macc = {main={name="Lathi", priority=2}, sub={name="Mephitis Grip", priority=1}, 
			head="Mallquis Chapeau +1", neck="Eddy Necklace", lear="Barkaro. Earring", rear="Enchntr. Earring +1",
			-- Helios Jacket
			body="Mallquis Saio +1", hands="Mallquis Cuffs +1", lring="Stikini Ring", rring="Stikini Ring",
			back="Ogapepo Cape", waist="Ovate Rope", legs="Mallquis Trews +1", feet="Mallquis Clogs +1"}
