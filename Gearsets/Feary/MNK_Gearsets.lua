...
if player.name == 'Feary' then
	...
	-- Standard/idle
	sets.idle.PDT = { 
					head="Hizamaru Somen +1", neck="Twilight Torque", lear="Merman's Earring", rear="Etiolation Earring",
					body="Hizamaru Haramaki +1", hands="Hizamaru Kote +1", lring=Aug.Darkring1, rring="Defending Ring",
					back="Repulse Mantle", waist="Black Belt", legs="Hizamaru Hizayoroi +1", feet="Hizamaru Sune-ate +1"}
	...
	sets.precast.WS['Victory Smite'] = { ammo="Ginsen",
					...
					back="Atheling Mantle", waist="Prosilio Belt", legs="Hizamaru Hizayoroi +1", feet="Hizamaru Sune-ate +1"}
