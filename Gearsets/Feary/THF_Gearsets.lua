...
if player.name == 'Feary' then
	...
	sets.misc.Steps = {
				...
				back=Aug.Cape.THF.STP, waist="Dynamic Belt +1", legs="Meg. Chausses +1", feet="Meg. Jam. +1"}
	-- Magic Acc
	sets.misc.flourish = {}
	...
	sets.precast.JA["Sneak Attack"] = {
					...
					back=Aug.Cape.THF.WS, waist="Windbuffet Belt +1", legs="Meg. Chausses +1", feet="Meg. Jam. +1"}
	...
	sets.precast.JA["Trick Attack"] = {
					...
					back=Aug.Cape.THF.WS, waist="Windbuffet Belt +1", legs="Taeon Tights", feet="Taeon Boots"}
	...
	sets.precast.WS["Mercy Stroke"] = {
					...
					back=Aug.Cape.THF.WS, waist="Prosilio Belt", legs="Meg. Chausses +1", feet="Meg. Jam +1"}
	...
	sets.precast.WS['Aeolian Edge'] = set_combine(sets.precast.WS,{
			...
			body="Meghanada Cuirie", hands="Meg. Gloves +1", lring="Shiva Ring +1", rring="Shiva Ring +1",
			back=Aug.Cape.THF.WS, waist="Wanion Belt", legs="Meg. Chausses +1", feet="Meg. Jam. +1"})
end