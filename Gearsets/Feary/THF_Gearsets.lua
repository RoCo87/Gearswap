...
if player.name == 'Feary' then
	...
	sets.idle.PDT = { 
					...
					body="Emet Harness", hands="Umuthi Gloves", lring=Aug.Darkring1, rring="Defending Ring",
					back="Repulse Mantle", waist="Flume Belt", legs="Iuitl Tights +1", feet="Iuitl Gaiters"}

	sets.idle.MDT = { 
					head="Felistris Mask", neck="Twilight Torque", lear="Merman's Earring", rear="Etiolation Earring",
					body="Emet Harness", hands="Iuitl Wristbands +1", lring=Aug.Darkring1, rring="Defending Ring",
	...
	-- Accuracy TP Set - Need 1200 - 81 = 1119 Acc @ 990
