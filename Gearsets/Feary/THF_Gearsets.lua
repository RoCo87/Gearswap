...
if player.name == 'Feary' then
	...
	sets.idle.Evasion = set_combine(sets.idle.PDT,{
				head="Meghanada Visor", neck="Torero Torque", lear="Musical Earring", rear="Novia Earring",
				body="Meghanada Cuirie", hands="Meg. Gloves +1", lring="Rajas Ring", rring="Epona's Ring",
				back="Fravashi Mantle", waist="Twilight Belt", legs="Meghanada Chausses", feet="Meg. Jam. +1"})
	...
	sets.TP.Acc = {	ammo="Ginsen",
				head="Meghanada Visor", neck="Iqabi Necklace", lear="Brutal Earring", rear="Suppanomimi",
				body="Meghanada Cuirie", hands="Meg. Gloves +1", lring="Rajas Ring", rring="Epona's Ring",
				back=Aug.Cape.THF.STP, waist="Patentia Sash", legs="Meghanada Chausses", feet="Meg. Jam. +1"}
	...
	sets.precast.JA["Sneak Attack"] = {
					head="Meghanada Visor", neck="Love Torque", lear="Brutal Earring", rear="Pixie Earring",
					body="Meghanada Cuirie", hands="Meg. Gloves +1", lring="Ramuh Ring +1", rring="Epona's Ring",
					back=Aug.Cape.THF.STP, waist="Windbuffet Belt", legs="Meghanada Chausses", feet="Meg. Jam. +1"}
	...
	-- Weaponskills
	sets.precast.WS = { 
					head="Meghanada Visor", neck="Asperity Necklace", lear="Brutal Earring", rear="Moonshade Earring",
					body="Meghanada Cuirie", hands="Meg. Gloves +1", lring="Rajas Ring", rring="Ramuh Ring +1",
					back="Vespid Mantle", waist="Wanion Belt", legs="Meghanada Chausses", feet="Meg. Jam. +1"}
	...
	sets.precast.WS.SA = set_combine(sets.precast.WS,{
					...
					body="Meghanada Cuirie", hands="Meg. Gloves +1", lring="Rajas Ring", rring="Ramuh Ring +1",
					back=Aug.Cape.THF.STP, waist="Wanion Belt", legs="Meghanada Chausses", feet="Meg. Jam. +1"})
	...
	sets.precast.WS["Mercy Stroke"] = {
					head="Meghanada Visor", neck="Fotia Gorget", lear="Vulcan's Pearl", rear="Vulcan's Pearl",
					body="Meghanada Cuirie", hands="Meg. Gloves +1", lring="Ifrit Ring +1", rring="Ifrit Ring +1",
					back="Vespid Mantle", waist="Prosilio Belt", legs="Meghanada Chausses", feet="Meg. Jam +1"}
	...
	sets.precast.WS["Rudra's Storm"] = {
					head="Meghanada Visor", neck="Fotia Gorget", lear="Brutal Earring", rear="Moonshade Earring",
					body="Meghanada Cuirie", hands="Meg. Gloves +1", lring="Rajas Ring", rring="Ramuh Ring +1",
					back="Kayapa Cape", waist="Wanion Belt", legs="Meghanada Chausses", feet="Meg. Jam. +1"}
	...
	sets.precast.WS['Aeolian Edge'] = set_combine(sets.precast.WS,{
			head="Meghanada Visor", neck="Fotia Gorget", lear="Crematio Earring", rear="Friomisi Earring",
			--  Shiva Ring +1 Shiva Ring +1 
			body="Meghanada Cuirie", hands="Meg. Gloves +1", lring="Shiva Ring", rring="Shiva Ring",
			back=Aug.Cape.THF.WS, waist="Wanion Belt", legs="Meghanada Chausses", feet="Meg. Jam. +1"})
	end