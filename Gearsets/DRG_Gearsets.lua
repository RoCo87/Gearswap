...
sets.idle.PDT = { 
                ...
                body="Mekira Meikogai", hands="Cizin Mufflers", lring=Aug.Darkring1, rring=Aug.Darkring2,
                back="Repulse Mantle", waist="Flume Belt", legs="Cizin Breeches", feet="Cizin Greaves"}

sets.idle.MDT = { 
				head="Yaoyotl Helm", neck="Twilight Torque", lear="Merman's Earring", rear="Merman's Earring",
                body="Mekira Meikogai", hands="Cizin Mufflers", lring=Aug.Darkring1, rring=Aug.Darkring2,
                back="Engulfer Cape", waist="Nierenschutz", legs="Cizin Breeches", feet="Cizin Greaves"}
...
sets.precast.WS["Stardiver"] = {ammo="Hagneia Stone",
                ...
                body="Miki. Breastplate", hands="Miki. Gauntlets", lring="Rajas Ring", rring="Pyrosoul Ring",
                back="Atheling Mantle", waist="Light Belt", legs="Cizin Breeches", feet="Iuitl Gaiters"}
