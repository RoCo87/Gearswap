...
if player.Name == 'Carrisa' then
		...
		sets.Resting = set_combine(sets.idle.PDT, {main="Boonwell Staff", sub="Umbra Strap",
				ammo="Clarus Stone", head="Nefer Khat", neck="Eidolon Pendant", lear="Moonshade Earring", rear="Antivenom Earring",
		...
		sets.idle.Standard = set_combine(sets.idle.PDT,{main="Bolelabunga",
				sub="Genbu's Shield", ammo="Dosis Tathlum", head="Wivre Hairpin", body="Supay Weskit", lear="Moonshade Earring", rear="Ethereal Earring", 
				lring=Aug.Darkring1.Carrisa, rring="Defending Ring", hands="Serpentes Cuffs", waist="Aswang Sash", legs="Nares Trews", feet="Herald's Gaiters"})
		...
		sets.precast.Elemental = set_combine(sets.precast.Fastcast,{head="Wicce Petasos +1", body="Wicce Coat +1", feet="Spaekona's Sabots"})
		...
		-- Enhancing 
		-- 
		sets.midcast.Enhancing = {sub="Fulcio Grip",head="Befouled Crown", neck="Colossus's Torque",body="Anhur Robe",hands="Ayao's Gloves",
