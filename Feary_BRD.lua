	...
	elseif spell.skill == "Singing" then
		...
		elseif spell.name == "Herb Pastoral" then
			...
			if Gjallarhorn == 1 or player.equipment.range == "Gjallarhorn" then
				-- Debuff
				if spell.target == 'MONSTER' then
					equip(sets.midcast.Macc,{range="Gjallarhorn"})
				-- BuffSongs
				else
...
-- Lullaby
	if spell.name == "Foe's Lullaby II" or spell.name == "Horde's Lullaby II" then
	...
	elseif spell.name == "Foe's Lullaby" or spell.name == "Horde's Lullaby" then
